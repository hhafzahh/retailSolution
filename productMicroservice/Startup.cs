...
namespace productMicroservice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<productMicroserviceContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("productMicroserviceContext")));
        }
